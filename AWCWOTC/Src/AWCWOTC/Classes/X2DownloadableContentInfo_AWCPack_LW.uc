...
static function FinalizeUnitAbilitiesForInit(XComGameState_Unit UnitState, out array<AbilitySetupData> SetupData, optional XComGameState StartState, optional XComGameState_Player PlayerState, optional bool bMultiplayerDisplay)
{
	...
	//return; // DEPRECATED
	`RedScreen("FinalizeUnitAbilitiesForInit CALLED");
	...
	{
		`RedScreen("FinalizeUnitAbilitiesForInit INSIDE FOR LOOP");
			...
			if (EarnedAWCAbilities[i].ApplyToWeaponSlot != eInvSlot_Unknown)
			{
				foreach CurrentInventory(InventoryItem)
				{
					...
					if (InventoryItem.InventorySlot == EarnedAWCAbilities[i].ApplyToWeaponSlot)
					{
						...
						`RedScreen("SourceWeaponRef found" @ AbilityName @ " eh " @ EarnedAWCAbilities[i].ApplyToWeaponSlot @ "but no weapon was found there." @ EarnedAWCAbilities[i].UtilityCat @ " ");
								//`RedScreen("SourceWeaponRef for " @ Data.SourceWeaponRef @ "found");
						...
						{
							`RedScreen("it is a eInvSlot_Utility");
...
static function ModifyEarnedSoldierAbilities(out array<SoldierClassAbilityType> EarnedAbilities, XComGameState_Unit UnitState)
{
	...
	`REDSCREEN("ModifyEarnedSoldierAbilities called !! __ !!");
	AWCState = class'LWAWCUtilities'.static.GetAWCComponent(UnitState);
	if (AWCState != none)
	{
